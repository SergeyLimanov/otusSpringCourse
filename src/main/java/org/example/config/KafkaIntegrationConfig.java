...
public class KafkaIntegrationConfig {
    ...
    public ConsumerFactory<String, AuthorResponse> authorResponseConsumerFactory() {
        ...
        // Создаем JsonDeserializer с отключенным type mapping
        JsonDeserializer<AuthorResponse> deserializer = new JsonDeserializer<>(AuthorResponse.class);
        deserializer.addTrustedPackages("*");
        deserializer.setUseTypeHeaders(false); // Отключаем использование type headers из Kafka
